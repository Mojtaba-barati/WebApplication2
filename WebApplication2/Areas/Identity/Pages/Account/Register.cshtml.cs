...
namespace WebApplication2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public IEnumerable<SelectListItem> componylist { get; set; }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel
            {
                ...
                componylist = _icompany.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(Input.RoleName==sd.Role_Company)
                {
                    user.compony = Input.componyid;
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.CreateAsync(user, Input.RoleName);
